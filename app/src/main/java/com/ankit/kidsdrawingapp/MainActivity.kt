package com.ankit.kidsdrawingapp
...
class MainActivity : AppCompatActivity() {
    ...
    private fun requestStoragePermission(){
        if(ActivityCompat.shouldShowRequestPermissionRationale(this,Manifest.permission.READ_EXTERNAL_STORAGE)){
            showRationaleDialog("Drawing App","needs to access your storage to insert a background image")
        }
        else{
            requestPermission.launch(arrayOf(Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.WRITE_EXTERNAL_STORAGE )) //todo
        }
            ...
            if(mBitmap!=null){
                try {
                    ...
                    val f = File(externalCacheDir?.absoluteFile.toString() + File.separator
                           + "KidsDrwaingApp_" + System.currentTimeMillis()/1000 + ".png")
